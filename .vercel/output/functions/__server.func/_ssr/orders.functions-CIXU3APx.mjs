import { a as TSS_SERVER_FUNCTION, i as createServerFn, s as getRequestHeader } from "./server-DVY_7xHe.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/orders.functions-CIXU3APx.js
...
var validateCoupon = createServerFn({ method: "POST" }).inputValidator((d) => objectType({
	...
	const { supabaseAdmin } = await import("./client.server-pWFcbJv3.mjs");
