...
//#region node_modules/.nitro/vite/services/ssr/assets/__23tanstack-start-server-fn-resolver-Des5cTAV.js
var manifest = {
	"11f995a8bfc43eee2f810f00bfc4a898b23bf6eadf646160b1be4d5b1baf9928": {
		functionName: "markWhatsAppSent_createServerFn_handler",
		importer: () => import("./orders.functions-C1jCc6NG.mjs")
	},
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/request-response-B5fXtxnG.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CAfyAO3b.js
var server_CAfyAO3b_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CxHXTrEs.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-gfFey6HA.mjs").then((n) => n.t),
		import("./start-DBnGRpVI.mjs"),
...
//#endregion
export { TSS_SERVER_FUNCTION as a, createServerEntry, server_default as default, getRequestHeader as i, createCsrfMiddleware as n, createServerFn as o, createMiddleware as r, getServerFnById as s, server_CAfyAO3b_exports as t };
